package com.github.AmitSurechChandra.orderservice.config;
...
public class AmqpConfig {
    ...
    @Bean
    Binding paymentDoneEventBinding(Queue orderServiceQueue, TopicExchange exchange) {
        return BindingBuilder.bind(orderServiceQueue).to(exchange).with("payment-service.payment.order-paid-event");
    }
}
